...
public class Programa {
    public Programa() {
        ...
        /* **** USO DE JOOPTIONPANE****
        JOptionPane.showMessageDialog(null,"Olá, eu sou uma mensagem");

        String resposta = JOptionPane.showInputDialog("Digite seu nome: ");
        ...
        while (opcao != 5) {
            ...
            switch (opcao) {
                ...
                case 3:
                    ...
                    String reuniaoInicio = scanner.nextLine();
                    LocalDateTime dataHoraInicio = formatarData(reuniaoInicio);
                    System.out.print("Digite a data e hora de início (dd/MM/yyyy HH:mm): ");
                    scanner.nextLine(); // limpar buffer
                    String reuniaoFim = scanner.nextLine();
                    LocalDateTime dataHoraFim = formatarData(reuniaoFim);
                    ...
                    Reserva reserva = new Reserva(idReuniao, dataHoraInicio, dataHoraFim, salaEscolhida, funcionarioResposavel);
                ...
                case 4:
                    ...
                    System.out.println("======= ADICIONAR FUNCIONÁRIO - REUNIÃO ======");
                    System.out.println("Insira o id do Funcionário: ");
